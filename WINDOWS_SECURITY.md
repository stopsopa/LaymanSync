...
When installing **LaymanSyncBulk** on Windows, you may see a warning like:
...
- **App:** LaymanSyncBulk-x.x.x-x64-setup.exe
- **Publisher:** Unknown publisher

### Why this happens

LaymanSyncBulk is distributed outside of the Microsoft Store and is currently **not signed with a trusted code-signing certificate**.
...
This warning does **not** mean LaymanSyncBulk contains malware.  
It means Windows cannot verify the publisher or reputation of the installer.

### How to run LaymanSyncBulk anyway
